...
(() => {
  ...
  const queryKeys=["phone","tel","p_phone","owner_phone","checkout_phone","subscription_phone","market_phone","msisdn","slug","market_slug","subscription_slug","pro_slug","owner","owner_id","source_slug","module","from","return","pin","code","token","session_token"];
  ...
  for(const storage of[localStorage,sessionStorage]){
    for(const key of generic)remove(storage,key);
    for(const key of [...phoneKeys,...slugKeys,...ownerKeys])remove(storage,key);
  }
